      ...
      <section className="text-center my-8 mx-4 p-4 bg-white rounded-lg">
        ...
        <section className="text-center my-8">
          ...
          <p className="text-lg">
            ...
            out of a shared vision to help people make informed decisions when
            they move and stay connected with their neighborhoods. We understand
            the challenges of relocating and the importance of feeling at home
            in a new area. That's why we created this platform—to provide
            valuable information and foster a sense of community. We believe
            that by combining our technical skills with our desire to make a
